...
jQuery(document).ready(function ($) {
    ...
    (function () {
        ...
        /* Deleted this JS Code and the drop down now works.. Keeping it on here just in case I need it later....
    ...
    (function () {
        ...
        settings.audio_player = new $.ScampPlayer($('#scamp_player'), {
            ...
            autoplay: false,
            /* Autoplay track */
            no_track_image: 'js/audio-player/img/no-track-image.png',
            ...
            check_files: false,
            /* Checks whether a track file exists */
    ...
    (function () {
        ...
        $form.on('click', 'input[type=submit]', function (e) {
            ...
            /* Ajax request */
            $.post('plugins/newsletter.php', $form.serialize(), function (data) {
            ...
            $('.site').imagesLoaded({
                ...
                .progress(function (instance, image) {
                    ...
                    if (image.isLoaded) {
                        ...
                        $('#loading-layer .progress-bar').css({
                            width: bar_width
                        });
